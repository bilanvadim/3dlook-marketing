...
|---|---|---|
| Корень (`.claude-plugin/`, `plugins/`, `CLAUDE.md`, `.claude/`) | Claude Code plugin marketplace: 9 агентов, правила оркестрации, enforcement безопасности | `/plugin marketplace add <repo>` в Claude Code |
...
/plugin install hermes-core@dev-sm
...
## Состав плагинов
product-architect · design-director · frontend-engineer · backend-engineer · database-engineer · platform-engineer · qa-engineer · security-auditor · sre-engineer. Покрывают все 14 слоёв production full-stack + дизайн.
