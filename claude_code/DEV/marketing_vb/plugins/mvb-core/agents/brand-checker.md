...
3. **AI-сигнатуры** — em dashes (—) — запрещены полностью, тройные параллелизмы, «It's not just X, it's Y», запрещённые слова (leverage, utilize, robust, seamless, comprehensive, harness, delve, navigate, tapestry, realm), plus (як конектор для benefits/proof points — запрещён).
