...
```
- [ ] Нет запрещённой терминологии Ассель: objective, reader/audience/below, this article/guide, by hand; we/our и you — в допустимых контекстах (terminology-guardrails.md)
