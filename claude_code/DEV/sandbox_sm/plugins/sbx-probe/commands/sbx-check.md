...
---
You are running inside the **sandbox_sm** profile. Report the facts first, then help
...
(`DEV/sandbox_sm/plugins/`, an external marketplace, or an MCP server).
...
- **What does it duplicate?** Name the plugin or skill already in `full_stack_sm` that
