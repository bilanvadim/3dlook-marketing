...
> Autonomous step-state (per-step retry/resume in the conductor via an `hc_steps` table) is the next phase — this plugin defines the logic; the conductor will execute it deterministically.
