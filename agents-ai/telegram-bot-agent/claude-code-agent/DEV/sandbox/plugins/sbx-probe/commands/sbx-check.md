...
---
You are running inside the **sandbox** profile. Report the facts first, then help
...
(`DEV/sandbox/plugins/`, an external marketplace, or an MCP server).
...
- **What does it duplicate?** Name the plugin or skill already in `dev` that
