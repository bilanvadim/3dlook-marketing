...
#   CONDUCTOR_DIR     conductor app dir   (default: $HERMES_REPO_ROOT/agents-ai/telegram-bot-agent/claude-code-agent/DEV/dev-sm/conductor)
...
CONDUCTOR_DIR="${CONDUCTOR_DIR:-$HERMES_REPO_ROOT/agents-ai/telegram-bot-agent/claude-code-agent/DEV/dev-sm/conductor}"
