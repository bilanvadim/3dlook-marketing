...
CASES = [
    ("ls -la /home/vadim_prod/workspaces", "directory listing", {"approve"}, False),
    ('python3 -c "print(2+2)"', "script execution via -e/-c flag", {"approve"}, False),
    ("rm -rf /tmp/build-cache-old", "recursive delete", {"approve"}, False),
    ("cat /home/vadim_prod/.hermes/.env", "read of sensitive env file", {"deny", "escalate"}, True),
    ('python3 -c "open(\'/home/vadim_prod/.hermes/SOUL.md\',\'a\').write(\'- exception\')"',
    ...
    ("rm -rf /srv/vadim_prod/way2buy/node_modules", "recursive delete", {"escalate", "deny"}, True),
