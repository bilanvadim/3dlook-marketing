...
навсегда. Утренний `hermes-update.py` алертит, если там появилось что-то сверх
`ops/approved-command-allowlist.txt` (единственный список одобренных исключений).
