...
*Scope note: this is a navigation guide to how 3DLOOK's FitXpress supports body-data workflows across health programs. It is not a primer on AI in healthcare in general (for that, see our overview of [AI in healthcare](https://3dlook.ai/content-hub/ai-healthcare-ai-used-today-key-applications-real-world-examples-industry-impact/)), and it is not a technical explainer of how the scanning works. It routes you to the material for your specific use case.*

## Why body data keeps failing health programs

Most conversations about AI in healthcare start too broad. The more useful question for a program owner is narrower: where does the body data you already rely on come from, and can you trust it for the decision it feeds?
...
**Telehealth and weight-loss (including GLP-1 programs).** Virtual-first clinics and metabolic programs lose members when progress is not visible, and weight alone rarely shows it. Repeatable body data makes real change visible between check-ins, which supports adherence and gives payer and employer partners defensible longitudinal outcomes. One weight-loss program, Yazen, ran roughly 34,000 scans in 2025. <!-- claim: FX-yazen-34k --> See [FitXpress for telehealth and weight-loss](https://3dlook.ai/fitxpress/for-telehealth-and-weight-loss/).
...
It is structured, repeatable body measurement captured by computer vision rather than by hand or by self-report. In a health program it provides objective inputs, such as BMI, composition, and 80+ measurements, that support review and documentation.
...
Telehealth and weight-loss, digital fitness, BMI verification, insurance underwriting, wellness rewards, bariatric pre-qualification, oncology survivorship monitoring, and clinical trials. Each has its own workflow and its own resource linked above.
