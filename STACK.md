...
4. `claude-code-agent/DEV/switch-profile.sh full_stack_sm-sm` — профиль Claude Code.
...
cd /home/vadim_prod/3dlook-marketing && opencode run 'Reply with exactly: BACKUP-OK'
