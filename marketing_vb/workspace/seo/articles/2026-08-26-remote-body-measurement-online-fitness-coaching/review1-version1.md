<!-- review1-version1.md — the text the reviewer read (Version 1 tab of the review doc).
     Identical in body to draft-v2-final.md, which is the article embedded in publish-package.md.
     Kept as a frozen copy so the revision diff has a stable base. -->
