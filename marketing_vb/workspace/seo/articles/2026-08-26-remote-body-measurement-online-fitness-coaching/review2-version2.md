<!-- review2-version2.md — the text the reviewer read (Version 2 tab of the review doc).
     Identical in body to draft-v3-revision1.md. Frozen so the revision-2 diff has a stable base. -->
