...
source_final: "final.md (2039 prose words, lint PASS)"
word_count: 2039
stop_rule: OK
---
...
- [x] **detector_clean** — ai_density 0.44/1000, hard_fails [], house_rules []
- [x] **keyword_h1** — «capture quality» в H1: «FitXpress User Experience and Capture Quality FAQ»
- [x] **keyword_h2** — keyword в 1 H2 (норма 1-2)
- [x] **claims_traceable** — claims_used: ['FX-CQ-001', 'FX-CQ-002', 'FX-CQ-003', 'FX-CQ-004', 'FX-CQ-005', 'FX-CQ-006', 'FX-CQ-007', 'FX-CQ-008', 'FX-CQ-009', 'FX-CQ-010', 'FXS-DELIVERY', 'FXS-IDS', 'FXS-LIFECYCLE', 'FXS-MEDICAL', 'FXS-OUTPUTS', 'FXS-POPULATION', 'FXS-SCOPE', 'FXS-SPEED']
- [x] **no_banned_claims** — banned claims + superseded figures gates
- [x] **word_count** — 2039 слов против target 2100 (полоса линтера ±15%; жёсткие ±10% = ok)
...
[ok  ] hard bans (detect-ai-tells)
         ...
         . ai_density: 0.44
         . verdict: CLEAN
         . rhythm_variation: 0.38
[ok  ] prose length
         prose words 2039 vs target 2100 (band 1785-2415)
         . prose_words: 2039
         . target: 2100
[ok  ] claim traceability
         . claims_used: ['FX-CQ-001', 'FX-CQ-002', 'FX-CQ-003', 'FX-CQ-004', 'FX-CQ-005', 'FX-CQ-006', 'FX-CQ-007', 'FX-CQ-008', 'FX-CQ-009', 'FX-CQ-010', 'FXS-DELIVERY', 'FXS-IDS', 'FXS-LIFECYCLE', 'FXS-MEDICAL', 'FXS-OUTPUTS', 'FXS-POPULATION', 'FXS-SCOPE', 'FXS-SPEED']
         . claims_known: 23
[ok  ] banned claims
...
[ok  ] sentence length
         ...
         . repeated_phrases: ['front and side x4', 'the capture flow x3', 'guides the user x3', 'and phone placement x3']
...
```
SEO / blog article · en · 2286 words
AI density: 0.44/1000 (budget 6.0) -> low
...
Текст НЕ дублируется в пакете: единственный источник — `final.md` (2039 prose words) рядом с этим файлом.
