# Daisy Blackwood — Director of Engineering — WithU
...
Been meaning to reach out: WithU's workout experience runs through audio, which means there's no camera in the loop today and no easy way for a member to see their own physical progress.

FitXpress could sit alongside that as an SDK: two photos, 80+ measurements and body composition back in under 45 seconds, no change to the audio-first workout itself.
