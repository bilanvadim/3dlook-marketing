# Ryan Sherreard — Head of Product — Coopah
...
Couldn't help but ask: Coopah's runners can get genuinely fitter and faster over a 10K while the number on their bathroom scale barely moves, and that mismatch is a real churn risk for a coaching subscription.

FitXpress closes that gap from two phone photos: 80+ measurements and body composition in under 45 seconds, dropping into the member profile next to training data.
