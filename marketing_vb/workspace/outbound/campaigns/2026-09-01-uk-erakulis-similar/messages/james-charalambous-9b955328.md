# James Charalambous — Managing Director — Fiit
...
Saw your activity: Fiit's whole pitch is personalized training that gets people real results, but the only progress proof most members get is a lighter number on a scale that lags behind what training is actually doing to their body.

We built FitXpress to give a member that proof instead: two photos, 80+ measurements and a 3D progress model in under 45 seconds, feeding into their profile.
