...
profile: olena
person_id: c1a150f2c808
full_name: Aebischer Olivier
title: Product Owner
...
# Aebischer Olivier — Product Owner — Medgate Switzerland
...
```
Hi Aebischer,
Spotted something relevant to Medgate Switzerland. Virtual care platforms adding weight management often hit the same wall: no objective way to show a patient's progress between calls.
