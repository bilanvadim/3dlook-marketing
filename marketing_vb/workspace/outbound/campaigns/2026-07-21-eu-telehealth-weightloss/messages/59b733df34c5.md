...
profile: olena
person_id: 59b733df34c5
full_name: Sabine Helterlin
title: Head of Market Management
...
# Sabine Helterlin — Head of Market Management — Medgate Schweiz
...
```
Hi Sabine,
Spotted something relevant to Medgate Schweiz. Virtual care platforms adding weight management often hit the same wall: no objective way to show a patient's progress between calls.
