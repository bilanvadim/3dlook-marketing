...
profile: olena
person_id: 5bd5e0479425
full_name: Sherife Begaj
title: Product Owner
...
# Sherife Begaj — Product Owner — hellocare.ai
...
```
Hi Sherife,
Had a thought after reading about hellocare.ai. Virtual care platforms adding weight management often hit the same wall: no objective way to show a patient's progress between calls.
