...
profile: olena
person_id: 5a882cd23a89
full_name: Charlotte Seiler
...
# Charlotte Seiler — Head of Operational Excellence — Qare
...
```
Hi Charlotte,
Had a thought after reading about Qare. Virtual care platforms adding weight management often hit the same wall: no objective way to show a patient's progress between calls.
