...
profile: olena
person_id: b040fb8d055d
full_name: Sebastien Panchaud
title: Chief Operating Officer (Sales & Operations)
company: Qare.fr
location: France
...
# Sebastien Panchaud — Chief Operating Officer (Sales & Operations) — Qare.fr
...
```
Hi Sebastien,
Quick idea for your team. Virtual care platforms adding weight management often hit the same wall: no objective way to show a patient's progress between calls.
