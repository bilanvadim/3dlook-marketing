...
profile: olena
person_id: f3819bacb297
full_name: Cyril Vincler
title: CTO
company: myDiabby
location: Monaco
...
```
Hi Cyril,
Had a thought after reading about myDiabby. Virtual care platforms adding weight management often hit the same wall: no objective way to show a patient's progress between calls.
