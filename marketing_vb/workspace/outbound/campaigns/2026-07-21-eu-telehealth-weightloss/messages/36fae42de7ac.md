...
profile: olena
person_id: 36fae42de7ac
full_name: Romain Fleury
...
# Romain Fleury — Head of product design — Qare
...
```
Hi Romain,
Thought I'd share something specific to your program. Virtual care platforms adding weight management often hit the same wall: no objective way to show a patient's progress between calls.
