...
PROOF_POINTS = [
    ...
    "The demographic training range is notable: ages 16-78, weight 38-210 kg, height 150-220 cm. This isn't a model trained on fit 25-year-olds — it works for the full spectrum of patients and members a health organization serves.",
