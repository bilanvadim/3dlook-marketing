...
published: not live on 2026-09-11 (URL returns 404). This is the editor's final from the article's Google Doc
word_count: ~1877 prose
h2_count: 9
cta_type: evaluation (talk to 3DLOOK about the intake workflow)
source: Google Doc tab "Final version", fetched 2026-09-11
...
reference_role: >
  ...
  "long sentences, repetition, reads as obviously AI"; this is her rewrite of it. Prose
  sentences average 14.7 words against our 17.7. Rules and before/after pairs:
  brand-assets/style-guides/editorial-rewrites.md.
known_issues: |
  - Privacy paragraph: "A Business Associate Agreement ... is available on request", and the
    dropped "processes no personal identifiers" and 30-day photo window, differ from
    compliance.md, which Vadim kept unchanged on 2026-09-11. Copy the shape of those sentences,
    not their wording. The medical-device sentence and the disability limitation ARE canon since
    the same day (editorial-guardrails.md #6, accuracy-formulations.md §5).
  - When the page goes live, replace this body with the live transcription and update `published`.
---
